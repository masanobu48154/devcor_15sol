...
class FDMClient:
    ...
    def __init__(self, host, port=443, username='admin',
                 password='1234QWer', log=None):
        self.host = host
        self.port = port
    ...
    def _send_request(self, url, method='get', headers=None,
        ...
        response = request_method(url, verify=False, headers=headers,
    ...
    def put_access_rule(self, data):
        ...
        response = self._send_request(url, method='put', headers=headers,
                                      body=data)
        return response
